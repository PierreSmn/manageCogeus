                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              FutureBuilder<List<ClientsNp1Row>>(
                                                                                future: ClientsNp1Table().querySingleRow(
                                                                                  queryFn: (q) => q.eq(
                                                                                    'id',
                                                                                    FFAppState().activeNp1,
                                                                                  ),
                                                                                ...
                                                                                builder: (context, snapshot) {
                                                                                  ...
                                                                                  List<ClientsNp1Row> containerClientsNp1RowList = snapshot.data!;

                                                                                  final containerClientsNp1Row = containerClientsNp1RowList.isNotEmpty ? containerClientsNp1RowList.first : null;
                                                                                        ...
                                                                                        child: Column(
                                                                                          ...
                                                                                          children: [
                                                                                            ...
                                                                                            Padding(
                                                                                              ...
                                                                                              child: FFButtonWidget(
                                                                                                onPressed: () async {
                                                                                                  _model.userRow21 = await UsersTable().queryRows(
                                                                                                    queryFn: (q) => q.eq(
                                                                                                      'id',
                                                                                                      currentUserUid,
                                                                                                    ),
                                                                                                  );
                                                                                                  if (_model.userRow21!.firstOrNull!.activeSub!) {
                                                                                                    FFAppState().activeSub = true;
                                                                                                    safeSetState(() {});

                                                                                                    context.pushNamed('home');
                                                                                                  } else {
                                                                                                    _model.clientRow2 = await ClientsTable().queryRows(
                                                                                                      queryFn: (q) => q.eq(
                                                                                                        'id',
                                                                                                        _model.userRow21?.firstOrNull?.clientId,
                                                                                                      ),
                                                                                                    );
                                                                                                    await launchURL('${_model.clientRow2?.firstOrNull?.stripeLink != null && _model.clientRow2?.firstOrNull?.stripeLink != '' ? _model.clientRow2?.firstOrNull?.stripeLink : 'https://buy.stripe.com/4gwbIObk258E2kM7su'}?prefilled_email=$currentUserEmail');
                                                                                                  }
