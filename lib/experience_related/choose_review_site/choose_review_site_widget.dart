...
class ChooseReviewSiteWidget extends StatefulWidget {
  const ChooseReviewSiteWidget({
    super.key,
    required this.id,
  });
  ...
  @override
  State<ChooseReviewSiteWidget> createState() => _ChooseReviewSiteWidgetState();
}

class _ChooseReviewSiteWidgetState extends State<ChooseReviewSiteWidget> {
  late ChooseReviewSiteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseReviewSiteModel());
